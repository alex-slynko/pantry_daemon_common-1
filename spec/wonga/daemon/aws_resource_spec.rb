...
describe Wonga::Daemon::AWSResource do
  ...
  context "#stop" do
    ...
    before(:each) do
      ...
      allow(subject).to receive(:logger).and_return(instance_double('Wonga::Daemon.Wonga::Daemon.logger').as_null_object)
    end
    ...
    context "machine stopped" do
      ...
      it "should return true" do
        expect(subject.stop({"instance_id"=>instance_id})).to be_true
      end
    end
